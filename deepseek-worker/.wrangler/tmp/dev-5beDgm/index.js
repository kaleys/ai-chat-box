...
// .wrangler/tmp/bundle-WfSMdd/middleware-loader.entry.ts
init_modules_watch_stub();

// .wrangler/tmp/bundle-WfSMdd/middleware-insertion-facade.js
init_modules_watch_stub();
...
// node_modules/@graphql-tools/schema/esm/makeExecutableSchema.js
function makeExecutableSchema({ typeDefs, resolvers: resolvers2 = {}, resolverValidationOptions = {}, inheritResolversFromInterfaces = false, updateResolversInPlace = false, schemaExtensions, defaultFieldResolver: defaultFieldResolver3, ...otherOptions }) {
...
async function callDeepSeekAPI(messages, model = "deepseek-chat", temperature = 0.7, max_tokens = 2e3, apiKey) {
  try {
...
var resolvers = {
  Query: {
    health: /* @__PURE__ */ __name(() => "\u2705 DeepSeek GraphQL API is running!", "health"),
    models: /* @__PURE__ */ __name(() => [
      "deepseek-chat",
      "deepseek-coder",
      "deepseek-reasoning"
    ], "models")
  ...
  Mutation: {
    sendMessage: /* @__PURE__ */ __name(async (parent, args, context) => {
...
// src/index.js
var DEEPSEEK_API_URL2 = "https://api.deepseek.com/chat/completions";
...
var yoga = createYoga({
  schema,
  context: /* @__PURE__ */ __name(async ({ request, env }) => ({
    request,
    env
  }), "context"),
  cors: {
  ...
  async fetch(request, env, ctx) {
    ...
    if (request.method === "POST" && url.pathname === "/chat") {
      try {
        ...
        const response = await fetch(DEEPSEEK_API_URL2, {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
    ...
    return new Response(`
			<h1>\u{1F680} DeepSeek Chat Worker</h1>
