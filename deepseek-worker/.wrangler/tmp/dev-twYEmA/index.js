...
// .wrangler/tmp/bundle-p4QYvX/middleware-loader.entry.ts
init_modules_watch_stub();

// .wrangler/tmp/bundle-p4QYvX/middleware-insertion-facade.js
init_modules_watch_stub();
...
var yoga = createYoga({
  schema,
  resolvers,
  context: /* @__PURE__ */ __name(async ({ request, env, executionContext }) => ({
    request,
    env,
    executionContext
  }), "context"),
